...
function changeImage(element) {
  element.setAttribute("src", "assets/lobby strada.jpg");
  // element.setAttribute("height", "300")
  // element.setAttribute("class", "jumbotron-img")
}

function changeImageBack(element) {
  element.setAttribute("src", "assets/ss strada.png");
  // element.setAttribute("height", "300")
}

/* --------------------------- Challenge of Meeting 12 | Change Jumbotron Title ------------------------- */
function changeTitle(element) {
  element.innerHTML = "Dengan menerapkan Industri kerja";
}

function changeTitleBack(element) {
  element.innerHTML = "Sekolah Andalan Mahasiswa Jakarta Utara";
}
...
if (btnSubmit) {
  btnSubmit.addEventListener("click", function () {
    ...
    next.setAttribute(
      "value",
      "https://mr-wahyu.netlify.app.netlify.app/contact.html"
    );
  });
}
